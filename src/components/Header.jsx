...
import headerLaptop from "../assets/images/laptop-removebg-preview.png"
        ...
        return (
            <div>
                ...
                <div className="flex justify-center items-center py-6">
                    <div>
                        <img src={headerLaptop} alt="Laptop" />
                    </div>
                    <div className="text-white">
                        <p className="text-sm">Welcome to</p>
                        <h1 className="font-roboto font-bold text-6xl w-96 py-3">Relap Gadgets Store</h1>
                        <button className="bg-amber-500 px-8 py-1 rounded-2xl text-lg">Store</button>
                    </div>
                </div>
            </div>
        ...
        <div className="py-5">
            ...
            <div className="flex flex-col-reverse p-5">
                    ...
                    <div className="text-white mb-6">
                        <p className="text-sm">Welcome to</p>
                        <h1 className="font-roboto font-bold text-5xl w-96 py-3">Relap Gadgets Store</h1>
                        <button className="bg-amber-500 px-8 py-1 rounded-2xl text-lg">Store</button>
                    </div>
                </div>
        </div>
